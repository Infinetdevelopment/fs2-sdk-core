...
const DEFAULT_NETWORKS = [ChainId.MAINNET, ChainId.TESTNET, ChainId.ETHEREUM, ChainId.GOERLI]
...
export const V2_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.TESTNET]: '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D' // UNI copied over from fork
}
/**
...
export const V2_ROUTER_ADDRESSES: AddressMap = {
  ...
  [ChainId.ETHEREUM]: '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D', // UNI copied over from fork
  [ChainId.TESTNET]: '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D' // UNI copied over from fork
}
...
export const CHAIN_TO_ADDRESSES_MAP: Record<SupportedChainsType, ChainAddresses> = {
  [ChainId.MAINNET]: PULSECHAIN_ADDRESSES, // copied over from fork
  [ChainId.TESTNET]: PULSECHAIN_ADDRESSES, // copied over from fork
